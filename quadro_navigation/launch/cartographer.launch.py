# File originally from: https://github.com/rigbetellabs/tortoisebot
# License: MIT License
# Copyright (c) Rigbetel Labs
# Modified by Sudhanshu Pawar on 2025-04-10
...
def generate_launch_description():
  prefix_address = get_package_share_directory('quadro_slam') 
  ...
  # rviz_config_file_path = os.path.join(get_package_share_directory('quadro_slam'),'config','carto_slam.rviz')
